// Required for Next.js static export — pre-renders all listing pages at build time
export function generateStaticParams() {
  return [
    'listing-001', 'listing-002', 'listing-003', 'listing-004',
    'listing-005', 'listing-006', 'listing-007', 'listing-008',
    // Add more IDs here as you expand mockData.ts
  ].map((id) => ({ id }))
}
